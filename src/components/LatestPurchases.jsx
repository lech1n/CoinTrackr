...
const LatestPurchases = () => {
  ...
  return (
    <div className="p-2 pt-4 lg:pt-6">
      ...
      <h1  className="dark:text-white-txt pb-6 font-bold text-base sm:text-lg lg:text-xl">Transactions</h1>
      ...
      {latestPurchases.map((item)=>(
         <tr key={item.transactionId} className="border-b border-grey-txt dark:border-purple cursor-pointer ">
